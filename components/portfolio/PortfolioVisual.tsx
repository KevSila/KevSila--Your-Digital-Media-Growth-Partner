import { Activity, ArrowRight, BadgeCheck, BarChart3, CheckCircle2, ClipboardList, CreditCard, Database, Dumbbell, PackageCheck, Sparkles, UsersRound } from 'lucide-react';
import type { PortfolioProject } from '../../data/portfolioProjects';

const AsiliVisual = () => (
  <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-ink p-5 shadow-2xl sm:p-7">
...
const BeeEpicVisual = () => (
  <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#0b1c34] p-5 shadow-2xl sm:p-7">
...
const StawiVisual = () => (
  <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#091a20] p-5 shadow-2xl sm:p-7">

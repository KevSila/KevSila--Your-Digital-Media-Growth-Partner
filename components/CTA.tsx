...
const CTA = () => (
  <section className="relative overflow-hidden bg-ink py-24 sm:py-32">
    ...
    <div className="shell relative text-center"><span className="eyebrow-light">Your next step</span><h2 className="mx-auto mt-6 max-w-4xl font-display text-4xl font-bold leading-tight tracking-[-.04em] text-white sm:text-5xl lg:text-6xl">Your business should not depend on remembering everything.</h2><p className="body-lg mx-auto mt-7 max-w-2xl text-slate-copy">Let us identify where leads, time, and information are getting lost—and build a practical system that helps your business run better.</p><div className="mt-10 flex flex-col justify-center gap-3 sm:flex-row"><a href={WHATSAPP_LINK} target="_blank" rel="noreferrer" className="btn-primary">Book a diagnostic <ArrowRight className="h-4 w-4" /></a><a href={WHATSAPP_LINK} target="_blank" rel="noreferrer" className="btn-light"><MessageCircle className="h-4 w-4 text-mint" /> Message us on WhatsApp</a></div></div>
  </section>
);
